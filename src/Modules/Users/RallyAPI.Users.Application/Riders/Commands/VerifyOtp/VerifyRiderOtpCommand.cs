...
public sealed record VerifyRiderOtpCommand(string PhoneNumber, string Otp)
    : IRequest<Result<VerifyRiderOtpResponse>>;

public sealed record VerifyRiderOtpResponse(
    Guid RiderId,
    string AccessToken,
    string RefreshToken,
